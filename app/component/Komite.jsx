          ...
          <div className="box pt-5" id="visimisi">
            ...
            <div className="text-left mx-10 bg-white border-2 rounded-lg w-auto h-auto items-center">
              <div className="text-base px-2 text-wrap">
                ...
                gedung majalengka creative center sebagai ruang edukasi kreasi
                dan ekspresi bagi para pelaku ekonomi kreatif di kabupaten
                majalengka
                <div>
                ...
                <div>
                  ...
                  kreatif sebagai payung hukum bagi tumbuh kembangangnya
                  ekosistem ekonomi kreatif di kabupaten majalengka
                </div>
              </div>
            </div>
          </div>
